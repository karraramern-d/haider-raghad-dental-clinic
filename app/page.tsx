...
export default function HomePage() {
  ...
  const [form, setForm] = useState({ fullName: "", phone: "", date: "", time: "", patientType: "new", sessionNumber: "", purpose: "" });
